            ...
            {hilos.map((hilo) => (
                <div className='Thread_Card' key={hilo.id}>
                  ...
                  <div className='footer'>
                    <a href={'/user/' + hilo.nickname} className='avatar_' 
                    style={{
                      backgroundImage: `url(${hilo.enlace_imagen !== null ? hilo.enlace_imagen : '../images/profile/profile.png'})`,
                       }}                   
                    >
                    </a>
                    <div className='name'>
                      <a href={'/user/' + hilo.nickname} className='name_nickname'>{hilo.nickname}</a> 
