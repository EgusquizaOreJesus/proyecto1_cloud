  ...
  const handleTextareaInput = () => {
    ...
    const textareaRef = useRef(null);
      ...
      const handleSavehClick =async (e) => {
        ...
        try {
            const response = await axios.post(`${backendUrl}/usuarios/`+userId+'/upload_picture', formData);
            ...
            try {
                const response = await axios.post(`${backendUrl}/usuarios/`+userId+'/upload_picture', formDataBanner);
